...
- Layout guides: stable-ID Grid, Columns, or Rows entries with controlled visibility and size plus add, update, and remove callbacks. Guides render in Composition Design because they belong to the composition canvas, never to an element selection.
