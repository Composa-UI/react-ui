...
// Source of truth: tokens/composa.tokens.json (foundations) + docs-site/data/*.json
// (per-component annotations). Emits docs-site/dist/index.html.
...
<div class="app">
  ...
  <main>
    ...
    <p class="muted">Generated by <code>docs-site/build.mjs</code> from <code>tokens/composa.tokens.json</code> + <code>docs-site/data/*.json</code>.</p>
  </main>
</div>
<script>
